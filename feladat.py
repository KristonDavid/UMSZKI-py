...
# 3. feladat
# ▪ Ha a decemberi és a novemberi adatsor is egy-egy nagybevásárlást jelképez,
# ▪ Mennyi a kosarak végösszegének különbsége?
# ▪ Mennyi volt 'változások' között a legnagyobb drágulás?
# ▪ Mennyi volt 'változások' között a legnagyobb áresés?



# 4. feladat
# ▪ A termékek árában a túl nagy változás valamilyen torzító hatás eredménye.
# ▪ Vezessen be egy üres lista változót 'tisztított' néven!
# ▪ Index használata nélkül járja végig a 'változás' adatokat!
#     ▪ Ha az akutális érték -30-nál nagyobb de 30%-nál kisebb
#     ▪ akkor vegye fel az értéket a tisztított listába!
# ▪ A ciklus után írja parancssorra a szűrt adatokat!
